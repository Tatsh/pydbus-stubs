...
You write comprehensive pytest test suites for pydbus-stubs. Follow all conventions in
...
def test_my_command_success(runner: CliRunner, mocker: MockerFixture) -> None:
    mock_func = mocker.patch('pydbus-stubs.commands.module.some_function')
